...
public class RegistrationTest {
    ...
    public void testRegistrationValid() {
        ...
        //Your personal info
        String email = "12k334qwer@umail.com";
...
//        webDriver.findElement(By.name("button[name$='SubmitCreate']")).click();
        ...
        webDriver.findElement(By.id("customer_firstname"))
                .sendKeys("Vika");
        logger.info("Input customer firstname - Vika");
        webDriver.findElement(By.id("customer_lastname"))
                .sendKeys("Konkhg");
        logger.info("Input customer lastname - gjkl");
        webDriver.findElement(By.id("email")).clear();
        webDriver.findElement(By.id("email")).sendKeys(email);
        logger.info("Input email - " + email);
        webDriver.findElement(By.id("passwd"))
                .sendKeys("1234qwer");
        logger.info("Input password - 1234qwer");

        //your address
        webDriver.findElement(By.xpath("//input[@id='firstname']")).clear();
        webDriver.findElement(By.xpath("//input[@id='firstname']")).sendKeys("Vika");
        logger.info("Input first name - Vika");
        webDriver.findElement(By.xpath("//input[@id='lastname']")).clear();
        webDriver.findElement(By.xpath("//input[@id='lastname']")).sendKeys("Kondratova");
        logger.info("input last name - Kondratova");
